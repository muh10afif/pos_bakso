...
class Transaksi extends CI_Controller {
	...
	public function index()
	{
		...
		// }
		$kategori = $this->db->query('SELECT DISTINCT mst_kategori.id, mst_kategori.kategori, mst_kategori.created_at FROM mst_kategori INNER JOIN mst_product ON mst_kategori.id = mst_product.id_kategori WHERE mst_product.id_user = '.$this->session->userdata('id_user'))->result_array();
		$data 	= [
			'title'		=> 'Transaksi',
			'isi'		=> 'transaksi/lihat',
	...
	public function simpan_transaksi()
	{
		...
		else
		{
			...
			$transaksi = $this->transaksi->cari_data_kd_tr('trn_transaksi', ['id_user' => $this->session->userdata('id_user')])->row_array();
	...
	public function cetak_nota($id_transaksi, $pot_harga) {
		...
		$dt_judul = $this->ambil_string("Raden Rangga Kencana No. 45, Mekarwangi, Bandung");
