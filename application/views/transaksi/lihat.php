...
<div class="row mt-3 ml-2 mr-2">
    ...
    <div class="card shadow" style="height: 50rem;">
        ...
        <div class="tab-content" id="nav-tabContent">
            <?php $c = 0; foreach ($kategori as $a) : ?>
                ...
                <?php $kat = $this->transaksi->cari_data_order('mst_product', ['id_kategori' => $a['id'], 'status_tampil' => 1, 'id_user' => $this->session->userdata('id_user')], ['id' => 'asc'])->result_array();?>
                        ...
                        <div class="row">
                            ...
                            <?php $j = 0; $k = 0; foreach ($kat as $t) : ?>
                                ...
                                <div class="col-md-4 mt-3 menu-card" id="menu-<?= $t['id'] ?>">
                                    <div class="card text-white bg-<?= $warna[$wr] ?> text-center nm_product shadow card-hover pulse" style="height: 10rem; cursor: pointer; border-radius: 20px;" data-id="<?= $t['id'] ?>" nama-produk="<?= $t['nama_product'] ?>">
                                        <div class="card-body">
                                            <h3 class="text-white mb-2 nama-product" data-id="<?= $t['id'] ?>"><?= $t['nama_product'] ?></h3>
    ...
    <div class="card shadow">
        ...
        <div class="" style="margin-top: -7px;">
            <table class="table table-hover tabel-list table-borderless" width="100%">
                ...
                <tr class="font-weight-bold">
                    ...
                    <div class="row">
                        <div class="col-md-10 offset-md-2 easy-get4" data-id="tunai">
                            <input type="text" style="font-size: 18px;"  class="form-control input text-right easy-put4" name="tunai" id="tunai" value="0">
                        </div>
                    </div></td>
                </tr>
...
<script>
    ...
    $(document).ready(function () {   
        ...
        $('#potongan_harga').on('keyup', function () {
            ...
            var total_harga = tot - pot_harga;

            // isi total
            $("#total").text("Rp. "+separator(total_harga));
                    ...
                    if($('.'+id_product+'').text() == nama_product)
                    {
                        ...
                        if (stk != null) {
                            ...
                            else
                            {
                                ...
                                var subtotal    = (harga*jumlah) - (diskon1 * jumlah);

                                $('#total'+id_product+'').text('Rp. '+separator(subtotal));
                                $('#diskon'+id_product+'').text('Rp. '+separator(diskon1 * jumlah));
